...
3. **На фронті** юзер вводить MT5 логін, пароль, сервер (і при потребі обирає рахунок; токен і trading_account_id фронт бере з бекенду). Натискає **«Підключити»**.
